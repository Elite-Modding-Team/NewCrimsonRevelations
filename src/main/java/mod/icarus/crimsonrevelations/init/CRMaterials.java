...
public class CRMaterials {
    public static final ItemArmor.ArmorMaterial ARMOR_ANCIENT_CULTIST = EnumHelper.addArmorMaterial("ANCIENT_CULTIST", "ANCIENT_CULTIST", 17, new int[]{2, 5, 5, 2}, 13, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 0.0F).setRepairItem(new ItemStack(CRItems.CRIMSON_PLATE));
