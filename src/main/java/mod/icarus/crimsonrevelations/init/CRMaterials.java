...
public class CRMaterials {
    public static final ItemArmor.ArmorMaterial ARMOR_ANCIENT_CULTIST = EnumHelper.addArmorMaterial("ANCIENT_CULTIST", "ANCIENT_CULTIST", 17, new int[]{2, 5, 5, 2}, 13, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 1.0F).setRepairItem(new ItemStack(CRItems.CRIMSON_PLATE));
    ...
    public static final ItemArmor.ArmorMaterial ARMOR_CULTIST_PALADIN = EnumHelper.addArmorMaterial("CULTIST_PALADIN", "CULTIST_PALADIN", 30, new int[]{3, 6, 7, 3}, 25, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F).setRepairItem(new ItemStack(CRItems.CRIMSON_PLATE));
    public static final ItemArmor.ArmorMaterial ARMOR_CULTIST_RANGER = EnumHelper.addArmorMaterial("CULTIST_RANGER", "CULTIST_RANGER", 30, new int[]{3, 6, 7, 3}, 25, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F).setRepairItem(new ItemStack(CRItems.CRIMSON_PLATE));
